...
submit_spatial_array_for_run() {
    ...
    submit_sbatch \
        ...
        --export="ALL,MANIFEST=${manifest},FEATURE_DIR=${FEATURE_DIR},NN_SCRIPT=${NN_SCRIPT},ATHENA_SCRIPT=${ATHENA_SCRIPT},PY_ENV=${PY_ENV},ATHENA_ENV=${ATHENA_ENV},CONDA_SH=${CONDA_SH},RUN_NNSTATS=${RUN_NNSTATS},RUN_ATHENA=${RUN_ATHENA},RUN_ATHENA_INTERACTIONS=${RUN_ATHENA_INTERACTIONS},RUN_ATHENA_RIPLEY=${RUN_ATHENA_RIPLEY},ATHENA_RADIUS=${ATHENA_RADIUS},ATHENA_MIN_CELLS=${ATHENA_MIN_CELLS},ATHENA_REGIONS=${ATHENA_REGIONS},ATHENA_INTERACTION_PERMUTATIONS=${ATHENA_INTERACTION_PERMUTATIONS},MASTER_LOGDIR=${LOGDIR}" \
        "$WORKER_SCRIPT"
}

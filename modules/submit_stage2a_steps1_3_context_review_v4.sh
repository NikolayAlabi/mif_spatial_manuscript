...
#   bash submit_stage2a_steps1_3_context_review_v4.sh

set -euo pipefail

MODULE_DIR="${MODULE_DIR:-/projects/ovcare/users/nikolay_alabi/immuno/manuscript/modules}"
SCRIPT="${SCRIPT:-$MODULE_DIR/stage2a_steps1_3_context_review_v4.py}"
CONFIG_JSON="${CONFIG_JSON:-$MODULE_DIR/configs/stage2a_steps1_3_context_review_v4.json}"
